...
const import_admin_units_1 = require("./import-admin-units");
...
async function upsertRegion(name, parentId) {
...
async function upsertDistrict(name, regionId) {
...
async function main() {
    ...
    const adminUnitsFile = (0, import_admin_units_1.resolveAdminUnitsFile)(baseDir);
    if (adminUnitsFile) {
        try {
            await (0, import_admin_units_1.importAdminUnits)(prisma, adminUnitsFile);
        }
        catch (e) {
